...
public class Kuet extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Khulna University of Engineering and Technology");
    ...
    public void onClick(View view) {
        if(view.getId()==R.id.Website){
            Intent browse = new Intent(Intent.ACTION_VIEW, Uri.parse("http://www.kuet.ac.bd"));
            startActivity(browse);
        }
        if(view.getId()==R.id.UniversityLocation){
            Intent ba = new Intent(Kuet.this,maps_kuet.class);
            startActivity(ba);
        }
        if(view.getId()==R.id.AboutVarsityId){

            Intent ba = new Intent(Kuet.this,pdfreader_kuet.class);
            startActivity(ba);
        }
    }
}
