...
public class hsc_humanities extends AppCompatActivity implements View.OnClickListener {

    String[] group;
    public Spinner sscGroup;
    public EditText sscGpa;
    public EditText hscGpa;
    public EditText hscHumanitiesBangla;
    public EditText hscHumanitiesEnglish;
    public EditText hscHumaitiesEconomics;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hsc_humanities);
        ...
        hscHumanitiesBangla = (EditText) findViewById(R.id.hscHumanitiesBangla);
        hscHumanitiesEnglish = (EditText) findViewById(R.id.hscHumanitiesEnglish);
        hscHumaitiesEconomics = (EditText) findViewById(R.id.hscHumaitiesEconomics1);
    ...
    public void onClick(View view) {
        ...
        try {
            ...
            String BanglaGrade = hscHumanitiesBangla.getText().toString();
            double BanglaGpa = Double.parseDouble(BanglaGrade);

            String EnglishGrade = hscHumanitiesEnglish.getText().toString();
            double EnglishGpa = Double.parseDouble(EnglishGrade);

            String EconomicsGrade = hscHumaitiesEconomics.getText().toString();
            double EconomicsGpa = Double.parseDouble(EconomicsGrade);
            ...
            if (view.getId() == R.id.buttonCheck) {
                ...
                if (ssc_gpa <= 5.00 && hsc_gpa <= 5.00 && BanglaGpa <= 5.00 && EnglishGpa <= 5.00 )
                {

                    if ((ssc_gpa + hsc_gpa) >= 7.00) {
                    available_varsity.append(i++ + ". Dhaka University, KHA unit\n\n");
                }
                //Du gha unit baki condition need
                ...
                if (ssc_gpa >= 3.00 && hsc_gpa >= 3.00 && (ssc_gpa + hsc_gpa) >= 7.00 && EnglishGpa >= 3.00) {
                    available_varsity.append(i++ + ". JahangirNagar University, C Unit -> antorjatik somporko\n\n");
                }
                if (ssc_gpa >= 3.00 && hsc_gpa >= 3.00 && (ssc_gpa + hsc_gpa) >= 7.50 && EnglishGpa >= 3.50) {
                    available_varsity.append(i++ + ". JahangirNagar University, C Unit -> English\n\n");
                }
                if (ssc_gpa >= 3.00 && hsc_gpa >= 3.00 && (ssc_gpa + hsc_gpa) >= 7.00 && EnglishGpa >= 3.00 && BanglaGpa >= 3.50) {
                ...
                if (ssc_gpa >= 3.00 && hsc_gpa >= 3.00 && (ssc_gpa + hsc_gpa) >= 6.00 && BanglaGpa >= 3.00 && (EnglishGpa >= 3.00))
                //||  bangla soho onno akti subject e B ))
                {
                    available_varsity.append(i++ + ". JahangirNagar University, C Unit -> Natok o Nattototto\n\n");
                }
                if (ssc_gpa >= 3.00 && hsc_gpa >= 3.00 && (ssc_gpa + hsc_gpa) >= 6.50 && EnglishGpa >= 3.00 && BanglaGpa >= 3.00) {
                    available_varsity.append(i++ + ". JahangirNagar University, C Unit -> Protnototto\n\n");
                }
                if (ssc_gpa >= 3.00 && hsc_gpa >= 3.00 && (ssc_gpa + hsc_gpa) >= 7.00 && EnglishGpa >= 3.00 && BanglaGpa >= 4.00) {
                ...
                if (ssc_gpa >= 3.50 && hsc_gpa >= 3.50 && (ssc_gpa + hsc_gpa) >= 7.50) {// economics B
                ...
                if (ssc_gpa >= 3.50 && hsc_gpa >= 3.50 && (ssc_gpa + hsc_gpa) >= 8.00 && EnglishGpa >= 3.50) {
                    //economics B
                ...
                if (ssc_gpa >= 3.00 && hsc_gpa >= 3.00 && (ssc_gpa + hsc_gpa) >= 6.00) {
                ...
                if (ssc_gpa >= 3.00 && hsc_gpa >= 2.75 && (ssc_gpa + hsc_gpa) >= 6.25) {// psychology or Geography must
                ...
                if (ssc_gpa >= 3.50 && hsc_gpa >= 3.00 && (ssc_gpa + hsc_gpa) >= 6.00) { // All subject must be greater than C
                ...
                if (ssc_gpa >= 3.00 && hsc_gpa >= 3.00 && (ssc_gpa + hsc_gpa) >= 6.00) {
                    available_varsity.append(i++ + ". Barisal University, B Unit\n\n");
                ...
                if (ssc_gpa >= 2.75 && hsc_gpa >= 2.75 && (ssc_gpa + hsc_gpa) >= 6.50) {
                ...
                if (ssc_gpa <= 1.00 || hsc_gpa <= 1.00) {
                    ...
                    if(EconomicsGpa>5.00){
                        available_varsity.append(" Economics\n");
                    }
        ...
        {
            Toast.makeText(hsc_humanities.this, "Please enter GPA of all courses", Toast.LENGTH_SHORT).show();
        }
    }
