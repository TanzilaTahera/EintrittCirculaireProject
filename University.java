    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                switch (i){
                    ...
                    case 10:
                        ...
                        break;
                    case 11:
                        Intent B_Science= new Intent(University.this,Bangabandhu_science.class);
                        ...
                        break;
                    case 12:
                        Intent B_agri= new Intent(University.this,Bangabandhu_agri.class);
                        ...
                        break;
                    case 13:
                        Intent B_medical= new Intent(University.this,Bangabandhu_medical.class);
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                switch (i){
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        Intent comilla= new Intent(University.this,Comilla.class);
                        startActivity(comilla);
                        toSpeech.speak("Welcome to Comilla University", TextToSpeech.QUEUE_FLUSH, null, null);
                        break;
                    case 5:
                        Intent noakhali= new Intent(University.this,Noakhali.class);
                        ...
                        break;
                    case 6:
                        Intent rangamati= new Intent(University.this,Rangamati.class);
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                switch (i){
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        Intent islami = new Intent(University.this,Islami.class);
        ...
        BarisalSp.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                switch (i){
                    case 1:
                        Intent Barisal= new Intent(University.this,Barishal.class);
                        startActivity(Barisal);
                        toSpeech.speak("Welcome to Barisal University", TextToSpeech.QUEUE_FLUSH, null, null);
                        break;
                    case 2:
                        Intent PatuaKhali= new Intent(University.this,Patuakhali.class);
        ...
        RangpurSp.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                switch (i){
                    case 1:
                        Intent Rukeya= new Intent(University.this,Rokeya.class);
                        startActivity(Rukeya);
                        toSpeech.speak("Welcome to Begum Rokeya University", TextToSpeech.QUEUE_FLUSH, null, null);
                        break;
                    case 2:
                        Intent danesh= new Intent(University.this,Hajee_Danesh.class);
        ...
        MymensinghSp.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                switch (i){
                    case 1:
                        Intent BangladeshAgri= new Intent(University.this,Bd_Agriculture.class);
                        ...
                        break;
                    case 2:
                        Intent kobiKazi= new Intent(University.this,Kobi_kazi.class);
   ...
   /*
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id){
            ...
            case R.id.nav_home:
                Intent h= new Intent(University.this,Home.class);
                startActivity(h);
                break;
            case R.id.nav_account:
                Intent g= new Intent(University.this,Account.class);
                startActivity(g);
                break;
            case R.id.nav_university:
                Intent s= new Intent(University.this,University.class);
                startActivity(s);
                break;
//            case R.id.nav_settings:
//                Intent t= new Intent(University.this,Settings.class);
//                startActivity(t);
//                break;
//            case R.id.nav_rate:
//                Intent r= new Intent(University.this,Rate.class);
//                startActivity(r);
//                break;
           // case R.id.nav_logout:
              //  Intent l= new Intent(University.this,Logout.class);
              //  startActivity(l);
              //  break;
